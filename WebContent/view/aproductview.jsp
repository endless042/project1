...
<span class="w3-tag w3-xxlarge w3-white w3-margin-top w3-margin-right"><h3>태국 은빛 알로카시아</h4></span><hr></div>
 <!-- 사진쪽 div  -->
...
<p>
<span class="w3-tag w3-large  w3-white   ">현재가 : 70,000 원</span><span class="w3-tag w3-white w3-small">&#8725;&nbsp;&nbsp;시작가 : 5,000 원</span></p>
